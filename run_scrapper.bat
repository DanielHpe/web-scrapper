...
REM ADIONA AS VARIAVEIS DE AMBIENTE
setx /M PATH "C:\Program Files\wkhtmltopdf;C:\Python\Python37;C:\Python\Python37\Scripts;%PATH%"
REM VARIAVEIS DE AMBIENTE INSERIDAS COM SUCESSO
